...
- `SettingsDialog` independently loads local Codex CLI status and offers a verified npm/Homebrew update without making registry failures block model, style, theme, or account settings.
